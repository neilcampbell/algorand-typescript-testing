...
describe('Pure op codes', async () => {
  ...
  describe('bitLength', async () => {
    test.for([
      [Bytes(bigIntToUint8Array(0n)), 0],
      [Bytes(bigIntToUint8Array(1n)), 0],
      [Bytes(bigIntToUint8Array(MAX_UINT64)), 0],
      [Bytes(bigIntToUint8Array(MAX_UINT512)), 0],
      [Bytes(bigIntToUint8Array(MAX_UINT512 * MAX_UINT512)), 0],
  ...
  describe('bsqrt', async () => {
    test.for([0, 1, 2, 9, 13, 144n, MAX_UINT64, MAX_UINT512])(
      ...
      async (a, { appClientMiscellaneousOpsContract: appClient }) => {
        const uint8ArrayA = bigIntToUint8Array(BigInt(a))
  ...
  describe('btoi', async () => {
    test.for([
      Bytes(bigIntToUint8Array(0n)),
      Bytes(bigIntToUint8Array(1n)),
      Bytes(bigIntToUint8Array(MAX_UINT64)),
    ...
    test.for([
      Bytes(bigIntToUint8Array(MAX_UINT512)),
      Bytes(bigIntToUint8Array(MAX_UINT512 * MAX_UINT512, 128)),
