...
describe('Pure op codes', async () => {
  ...
  describe('extractUint16', async () => {
    ...
    test.each([
      ...
      expect(() => op.extractUint16(a, b)).toThrow(UINT64_OVERFLOW_UNDERFLOW_MESSAGE)
    })
  ...
  describe('extractUint32', async () => {
    ...
    test.each([
      ...
      expect(() => op.extractUint32(a, b)).toThrow(UINT64_OVERFLOW_UNDERFLOW_MESSAGE)
    })
  ...
  describe('extractUint64', async () => {
    ...
    test.each([
      ...
      expect(() => op.extractUint64(a, b)).toThrow(UINT64_OVERFLOW_UNDERFLOW_MESSAGE)
    })
  ...
  describe('substring', async () => {
    ...
    test.each([
      ...
      expect(() => op.substring(a, b, c)).toThrow(UINT64_OVERFLOW_UNDERFLOW_MESSAGE)
    })
  })
