...
describe('arc4.UFixedNxM', async () => {
  ...
  test.each([
    ...
    const result = UFixedNxM.fromBytes<UFixedNxM<32, 8>>(Bytes(value))
  ...
  test.each([
    ...
    const result = UFixedNxM.fromLog<UFixedNxM<32, 8>>(Bytes(logValue))
  ...
  test.each([
    ...
    expect(() => UFixedNxM.fromLog<UFixedNxM<32, 8>>(Bytes(logValue))).toThrowError('ABI return prefix not found')
  })
  ...
  test.each([
    ...
    const result = UFixedNxM.fromBytes<UFixedNxM<256, 16>>(Bytes(value))
  ...
  test.each([
    ...
    const result = UFixedNxM.fromLog<UFixedNxM<256, 16>>(Bytes(logValue))
    expect(avmResult).toEqual(expected)
    expect(result.native).toEqual(expected)
  })
  ...
  test.each([
    ...
    expect(() => UFixedNxM.fromLog<UFixedNxM<256, 16>>(Bytes(logValue))).toThrowError('ABI return prefix not found')
  })
